              ...
              if (snapshot.hasData &&
                ...
                return FutureBuilder(
                    ...
                    builder: (context, snapshot) {
                      if (snapshot.connectionState == ConnectionState.none ||
                          ...
                          children: [
                            Column(
                              ...
                              children: [
                                Padding(
                                    padding:
                                        EdgeInsets.fromLTRB(300, 50, 100, 0)),
                                Text(
                                  'Carregando Dados...',
                                  style:
                                      TextStyle(color: cor_base, fontSize: 30),
                                ),
                      ...
                      } else if (snapshot.data['results'][0]['city']
                              .toString() ==
                          null) {
                        return Center(
                          child: Text(
                        ...
                        String confirmados =
                            snapshot.data['results'][0]['confirmed'].toString();
                        String mortes =
                            snapshot.data['results'][0]['deaths'].toString();
                        String populacao = snapshot.data['results'][0]
