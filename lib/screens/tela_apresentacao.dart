          ...
          PageView(
            ...
            children: [
              CardApresentacao(
                ...
                textoL:
                    'Descubra o nível de exposição que você teve com pessoas infectadas.',
                textoR:
                    'Descubra o nível de exposição que você teve com pessoas infectadas.',
              ),
              CardApresentacao(
              ...
              CardApresentacao(
                ...
                textoL:
                    'Crie e gerencie alertas para monitorar o risco dos \nlugares que você \nprecisa ir.',
              ),
              CardApresentacao(
                img: Image.asset(
                  'assets/p4.png',
                ...
                textoL:
                    'Seja notificado se perto existe algum caso confirmado \nde contaminação pelo coronavírus',
              ),
              CardApresentacao(
                img: Image.asset(
                  'assets/p5.png',
                ...
                textoL:
                    'É possível acompanhar e cadastrar as aglomerações \nem tempo real pelo \nnosso site através \ndo mapa',
              ),
            ],
            onPageChanged: (x) {
              setState(() {
              ...
              child: OutlineButton.icon(
                ...
                onPressed: () {
                  ...
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => TelaSelecaoInstituicao()));
                },
                label: Text(
                  'Pular',
                  style:
                      TextStyle(fontWeight: FontWeight.bold, color: cor_base),
                ),
                borderSide: BorderSide(color: cor_base),
              )),
        ],
      ),
    ));
